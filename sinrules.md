# sinrules.md — stealth-lora: Regeln & Verbote
...
Dieses Repo (stealth-lora) ist Teil der **SIN-CLIs Stealth Suite** und MUSS:
...
Check mit: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-lora`
